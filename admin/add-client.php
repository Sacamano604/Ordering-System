...
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="form-inline">
  <table class="table">
    <tr>
      <td><strong>First Name: </strong></td>
      <td><input name="first" type="text" class="form-control" value="" maxlength="128" />
        * </td>
      <td><strong>Last Name:</strong></td>
      <td><input name="last" type="text" class="form-control" value="" maxlength="128" />
        * </td>
    </tr>
    <tr>
      <td><strong>Company:</strong></td>
    ...
    <tr>
      ...
      <td><strong>Email:</strong><strong></strong></td>
      <td><input name="email" type="text" class="form-control" value="" maxlength="128" />
        * </td>
    </tr>
    <tr>
      <td><strong>Privileges:</strong></td>
    ...
    <tr>
      <td><strong>Password:</strong></td>
      <td><input name="password" type="password" class="form-control" id="password" value="" maxlength="128" />
        * </td>
      <td><strong>Confirm Password:</strong></td>
      <td><input name="confirmpassword" type="password" class="form-control" id="confirmpassword" value="" maxlength="128" />
        * </td>
    </tr>
    </table>
